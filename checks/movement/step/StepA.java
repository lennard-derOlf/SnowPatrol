...
public class StepA extends Check {
    ...
    public boolean isOnGround(Player player) {
        ...
        return UtilCheat.isBlock(player.getLocation().getBlock().getRelative(BlockFace.DOWN),
                new Material[]{Material.OAK_FENCE, Material.OAK_FENCE_GATE, Material.COBBLESTONE_WALL, Material.LADDER});
    }
    ...
    public void onMove(PlayerMoveEvent event) {
        ...
        if (!getThotPatrol().isEnabled()
                ...
                || player.getLocation().getBlock().getType().equals(Material.WATER)) return;
